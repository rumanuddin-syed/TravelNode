...
const Testimonials = () => {
  const testimonialsData = [
    ...
    },
    {
      ...
      name: "Chris Johnson",
      description:
        "I've traveled with agencies, but TravelNode stands out. The seamless planning, knowledgeable, and unique destinations set them apart. An incredible way to explore the world!",
    },
    {
      pic: avatar1,
      name: "Emily Davis",
